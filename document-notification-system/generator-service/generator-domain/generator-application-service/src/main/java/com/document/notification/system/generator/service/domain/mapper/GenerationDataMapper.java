...
public interface GenerationDataMapper {
    ...
    /**
     * Converts DocumentGenerationFailedEvent to DocumentEventPayload for outbox pattern
     */
    DocumentEventPayload failedEventToDocumentEventPayload(DocumentGenerationFailedEvent event);
